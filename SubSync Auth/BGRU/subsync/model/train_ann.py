...
# Keras imports
from keras.layers import Dense, Input, LSTM, Conv1D, Conv2D, Dropout, Flatten, Activation, MaxPooling2D, GRU, Bidirectional
...
def ann_model(input_shape):
    ...
    model = Conv1D(filters=16, kernel_size=(3), activation='relu')(model)
    
    model = Bidirectional(GRU(28, dropout = 0.2))(model)
...
def train_ann():
    ...
    cutoff = EarlyStopping(monitor='val_loss', min_delta=0.001, mode='min', patience=10)
